...
D3D11StateSaver::D3D11StateSaver() :
	...
	m_pContext(NULL),
	m_primitiveTopology(D3D_PRIMITIVE_TOPOLOGY::D3D11_PRIMITIVE_TOPOLOGY_UNDEFINED),
	m_pInputLayout(NULL),
	m_pBlendState(NULL),
	...
	m_vertexOffset(0),
	m_pIndexBuffer(NULL),
	m_indexFormat(DXGI_FORMAT::DXGI_FORMAT_UNKNOWN),
	m_indexOffset(0)
{
	for (int i = 0; i < 4; ++i)
...
HRESULT D3D11StateSaver::saveCurrentState(ID3D11DeviceContext* pContext)
{
	...
	if (m_featureLevel >= D3D_FEATURE_LEVEL::D3D_FEATURE_LEVEL_10_0)
	{
		...
		if (m_featureLevel >= D3D_FEATURE_LEVEL::D3D_FEATURE_LEVEL_11_0)
		{
